...
function Login() {
  ...
  <div className="w-[100%] h-[100vh] bg-gray-300 flex justify-center items-center">
    <div className="hidden md:flex md:w-[60%] h-full bg-blue-700"></div>
    <div className="w-[100%] md:w-[40%] h-[100%] px-[30px] flex justify-center items-center">
    <div className="w-[80%]  h-[70%] bg-white rounded-xl shadow-xl flex flex-col items-center justify-center">
